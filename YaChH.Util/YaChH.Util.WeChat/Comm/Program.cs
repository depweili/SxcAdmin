...
using YaChH.Util.WeChat.Model;
using YaChH.Util.WeChat.Model.Request;
using YaChH.Util.WeChat.Model.Request.SendMessage;
using YaChH.Util;
using YaChH.Util.WeChat.Helper;

namespace YaChH.Util.WeChat
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //        {
            //        description="测试新闻",
            //        picurl="http://www.YaChH.cn/images/banner3.jpg",
            //        url="http://www.YaChH.cn/fdms/index.html",
            //        title="力软在线"
            //        },
            //                            new SendNews.SendItem
            //        {
