using YaChH.CodeGenerator.Model;
using YaChH.Util;
using System;
...
namespace YaChH.CodeGenerator.Template
{
    /// <summary>
    /// 版 本 6.1
    ...
    public class MultiTable
    {
        ...
        public string EntityBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> gridColumnModel, bool isChildTable)
        {
            ...
            try
            {
                ...
                sb.Append("using YaChH.Application.Code;\r\n\r\n");


                sb.Append("namespace YaChH.Application.Entity." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
        ...
        public string EntityMapBuilder(MultiTableConfigModel multiTableConfigModel, bool isChildTable)
        {
            try
            {
                ...
                StringBuilder sb = new StringBuilder();
                sb.Append("using YaChH.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
                sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

                sb.Append("namespace YaChH.Application.Mapping." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
                sb.Append("    /// Copyright (c) 2013-2016 北京亚春华信息科技有限公司\r\n");
        ...
        public string ServiceBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> colModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using YaChH.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using YaChH.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using YaChH.Data.Repository;\r\n");
            sb.Append("using YaChH.Util.WebControl;\r\n");
            sb.Append("using System;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Linq;\r\n");
            sb.Append("using YaChH.Util;\r\n");
            sb.Append("using YaChH.Util.Extension;\r\n\r\n");

            sb.Append("namespace YaChH.Application.Service." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 北京亚春华信息科技有限公司\r\n");
        ...
        public string IServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("namespace YaChH.Application.IService." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 北京亚春华信息科技有限公司\r\n");
        ...
        public string BusinesBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("using YaChH.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using YaChH.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using YaChH.Application.Service." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using YaChH.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace YaChH.Application.Busines." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 北京亚春华信息科技有限公司\r\n");
        ...
        public string ControllerBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using YaChH.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using YaChH.Application.Busines." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using YaChH.Util;\r\n");
            sb.Append("using YaChH.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace YaChH.Application.Web.Areas." + multiTableConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 北京亚春华信息科技有限公司\r\n");
