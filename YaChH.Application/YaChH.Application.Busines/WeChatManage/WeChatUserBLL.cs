...
using YaChH.Application.Entity.WeChatManage;
using YaChH.Application.IService.WeChatManage;
using YaChH.Application.Service.WeChatManage;
...
namespace YaChH.Application.Busines.WeChatManage
{
    /// <summary>
    /// 版 本 6.1
