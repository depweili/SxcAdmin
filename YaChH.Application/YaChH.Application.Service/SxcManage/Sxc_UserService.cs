...
namespace YaChH.Application.Service.SxcManage
{
    ...
    /// 描 述：Sxc_User
    /// </summary>
    public class Sxc_UserService : RepositoryFactory<Sxc_UserEntity>, Sxc_UserIService
    {
        ...
        public IEnumerable<Sxc_UserEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<Sxc_UserEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public Sxc_UserEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Sxc_UserEntity entity)
        {
