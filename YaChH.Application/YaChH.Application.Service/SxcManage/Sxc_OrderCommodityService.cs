...
namespace YaChH.Application.Service.SxcManage
{
    ...
    /// </summary>
    public class Sxc_OrderCommodityService : RepositoryFactory<Sxc_OrderCommodityEntity>, Sxc_OrderCommodityIService
    {
        ...
        public IEnumerable<Sxc_OrderCommodityEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<Sxc_OrderCommodityEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public Sxc_OrderCommodityEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Sxc_OrderCommodityEntity entity)
        {
