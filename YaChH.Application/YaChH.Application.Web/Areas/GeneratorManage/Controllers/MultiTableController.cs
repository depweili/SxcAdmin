using YaChH.Application.Busines.AuthorizeManage;
using YaChH.Application.Code;
using YaChH.Application.Entity.AuthorizeManage;
using YaChH.CodeGenerator;
using YaChH.CodeGenerator.Model;
using YaChH.CodeGenerator.Template;
using YaChH.Util;
using System.Web.Mvc;

namespace YaChH.Application.Web.Areas.GeneratorManage.Controllers
{
    /// <summary>
    /// 版 本 6.3.1
