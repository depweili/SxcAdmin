...
namespace YaChH.Application.IService.SxcManage
{
    ...
    /// </summary>
    public interface Sxc_AccountWithdrawIService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        IEnumerable<Sxc_AccountWithdrawEntity> GetPageList(Pagination pagination, string queryJson);
        /// <summary>
        /// 获取列表
        /// </summary>
        /// <param name="queryJson">查询参数</param>
        ...
        /// <returns></returns>
        Sxc_AccountWithdrawEntity GetEntity(string keyValue);
        #endregion
